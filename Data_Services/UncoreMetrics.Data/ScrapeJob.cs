...
namespace UncoreMetrics.Data
{
    public class ScrapeJob
    {
        ...
        public ScrapeJob(string gameType, string runType, string node, int runId, int progress, int totalDone, int totalCount, Guid runGuid, bool running, DateTime startedAt, DateTime lastUpdateUtc)
        {
            GameType = gameType;
            RunType = runType;
            Node = node;
