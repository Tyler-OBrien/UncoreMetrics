...
namespace UncoreMetrics.Data.Migrations.ServerContext
{
    ...
    [Migration("20230101060150_AddSquadServers")]
    partial class AddSquadServers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UncoreMetrics.Data.GameData.Location", b =>
                {
            ...
            modelBuilder.Entity("UncoreMetrics.Data.GameData.ServerPing", b =>
                {
                    ...
                    b.Property<float>("PingMs")
                        .HasColumnType("real");

                    b.HasKey("ServerId", "LocationID");

                    b.HasIndex("ServerId");

                    b.HasIndex("ServerId", "LocationID", "NextCheck");

                    b.ToTable("Server_Pings", (string)null);
                });
            ...
            modelBuilder.Entity("UncoreMetrics.Data.GameData.Squad.SquadServer", b =>
                {
                    b.HasBaseType("UncoreMetrics.Data.Server");
                    ...
                    b.Property<string>("LicenseSig")
                        .HasColumnType("text");

                    b.Property<int?>("NUMOPENPUBCONN")
                        .HasColumnType("integer");

                    b.Property<int?>("NUMPRIVCONN")
                        .HasColumnType("integer");

                    b.Property<int?>("NUMPUBCONN")
                        .HasColumnType("integer");

                    b.Property<int?>("OPENPRIVCONN")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("PublicQueueLimit")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ValidLicense");

                    b.ToTable("Squad_Servers", (string)null);
                });
            ...
            modelBuilder.Entity("UncoreMetrics.Data.GameData.Squad.SquadServer", b =>
                {
                    b.HasOne("UncoreMetrics.Data.Server", null)
                        .WithOne()
                        .HasForeignKey("UncoreMetrics.Data.GameData.Squad.SquadServer", "ServerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
