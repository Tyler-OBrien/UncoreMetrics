...
public static class IPAddressExtensions
{
    ...
    ///     IPv4: Loopback, link local ("169.254.x.x"), class A ("10.x.x.x"), class B ("172.16.x.x" to "172.31.x.x") and class
    ///     C ("192.168.x.x").<br />
    ...
    /// <example>
    ///     <code>bool isPrivate = IPAddress.Parse("127.0.0.1").IsPrivate();</code>
    /// </example>
    ...
    private static bool IsPrivateIPv4(byte[] ipv4Bytes)
    {
        ...
        bool IsLinkLocal()
        {
            return ipv4Bytes[0] == 169 && ipv4Bytes[1] == 254;
        }
        ...
        bool IsClassB()
        {
            return ipv4Bytes[0] == 172 && ipv4Bytes[1] >= 16 && ipv4Bytes[1] <= 31;
        }

        // Class C private range: 192.168.0.0 – 192.168.255.255 (192.168.0.0/16)
        bool IsClassC()
        {
            return ipv4Bytes[0] == 192 && ipv4Bytes[1] == 168;
        }
