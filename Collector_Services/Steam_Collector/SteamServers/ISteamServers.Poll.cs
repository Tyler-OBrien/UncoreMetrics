...
{
    /// <summary>
    /// Handles polling each of the input servers via Steam Server Query Protocol. Returns the result of the queries. 80 second timeout, so best to only pass in ~50k servers at a time.
    /// </summary>
