...
public partial class SteamServers : ISteamServers
{
        ...
        where T : Server, new()
    {
        ...
        foreach (var server in servers) server.CreateCustomServerInfo(_configuration.SecondsBetweenChecks);
        ...
        where T : Server, new()
    {
        ...
        var queue = new AsyncResolveQueue<QueryPoolItem<SteamListServer>, DiscoveredServerInfo<T>>(
